    ...
    <div class="w-100 justify-content-between d-flex">
        ...
        <div class="col-md-6">
            ...
            <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                ...
                <div class="form-group">
                    <label for="contactnumber" class="control-label">Contactnumber</label>
                    <input type="tel" name="contactnumber"  max=10 pattern="[1-9]{1}[0-9]{9}" class="form-control form" value="<?php echo $_settings->userdata('contactnumber') ?>" required>
                </div>
